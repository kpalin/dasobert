...
public class QueryServiceLocator extends org.apache.axis.client.Service implements uk.ac.ebi.www.ontology_lookup.OntologyQuery.QueryService {
    ...
    public uk.ac.ebi.www.ontology_lookup.OntologyQuery.Query getOntologyQuery(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            uk.ac.ebi.www.ontology_lookup.OntologyQuery.OntologyQuerySoapBindingStub _stub = new uk.ac.ebi.www.ontology_lookup.OntologyQuery.OntologyQuerySoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (uk.ac.ebi.www.ontology_lookup.OntologyQuery.Query.class.isAssignableFrom(serviceEndpointInterface)) {
                uk.ac.ebi.www.ontology_lookup.OntologyQuery.OntologyQuerySoapBindingStub _stub = new uk.ac.ebi.www.ontology_lookup.OntologyQuery.OntologyQuerySoapBindingStub(new java.net.URL(OntologyQuery_address), this);
                _stub.setPortName(getOntologyQueryWSDDServiceName());
                return _stub;
            }
        }
