...
import com.sun.msv.verifier.ErrorInfo.ElementErrorInfo;
import com.sun.msv.*;
/**
 ...
 */
public class RegVerifier extends AbstractVerifier implements IVerifier  {
	...
	//public class Verifier extends AbstractVerifier implements IVerifier {
	    ...
	    public RegVerifier(DocumentDeclaration documentDecl, ErrorHandler errorHandler) {
	    ...
	    protected Datatype[] feedAttribute(Acceptor child, String uri, String localName, String qName, String value)
	        ...
	        if (!child.onAttribute2(uri, localName, qName, value, this, null, attributeType)) {
	            ...
	            onError(
	                ...
	                new RegVerifier.BadAttribute(sti, qName, uri, localName, value));//change by jw to be a local class as protected access in MSV
	        }
